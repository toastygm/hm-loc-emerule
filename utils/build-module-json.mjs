...
template.url = "https://github.com/toastygm/hm-loc-emerule";
template.bugs = "https://github.com/toastygm/hm-loc-emerule/issues";
template.manifest =
    "https://github.com/toastygm/hm-loc-emerule/releases/latest/download/module.json";
template.download = `https://github.com/toastygm/hm-loc-emerule/releases/download/v${pkg.version}/module.zip`;
